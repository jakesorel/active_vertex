...
if __name__ == "__main__":
    make_directory("from_unsorted_control/analysis_tau0")
    vor = Tissue()
        ...
        for i in range(int(sys.argv[3])):
            for run in range(2):
                try:
                    ...
                    np.savez_compressed("from_unsorted_control/analysis_tau0/%d_%d.npz" % (Id,i + run*int(sys.argv[3])), n_islands=n_islands, n_bound=n_bound,
                                        mean_self=mean_self)
